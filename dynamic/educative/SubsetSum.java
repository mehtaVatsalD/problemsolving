public class SubsetSum {
	...
	public static void main(String...args) {
		...
		System.out.println("Brute force solution output: " + new BruteForce().solveSubsetSum(vals, sum));
		System.out.println("Memoization solution output: " + new Memoization().solveSubsetSum(vals, sum));
		System.out.println("Tabulation solution output: " + new Tabulation().solveSubsetSum(vals, sum));
	}
